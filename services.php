...
<head>
    ...
    <!--title-->
    <title>Services - StarLight</title>
                        ...
                        <div class="feature-grid">
                            <div class="feature-card bg-white shadow-sm highlight-card rounded-custom p-5" data-aos="fade-up" data-aos-delay="50">
                                ...
                                <div class="feature-content">
                                    <h3 class="h5">GRAPHIC DESIGNING </h3>
                                    <p>StarLight is a passionate graphic design service provider in the online market.</p>
                                    <p> Our creative designers offer outstanding and attention-grabbing visuals for brochures, banners,
                                        flyers, business cards, e-books, and many more.</p>
                                    <h6 class="mt-4">Included with...</h6>
                                    <ul class="list-unstyled mb-0">
                                        <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i>LOGO DESIGNING</li>
                                        <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i>MEDIA ADVERTISEMENT</li>
                                        <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i>PRODUCT & PACKAGING DESIGN</li>
                                        <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i>BROCHURE DESIGNING</li>
                                    </ul>
                                </div>
                                <a href="graphics-designing.php" class="link-with-icon text-decoration-none mt-3">View Details <i class="fas fa-arrow-right"></i></a>
                            </div>
                            <div class="feature-card bg-white shadow-sm rounded-custom p-5" data-aos="fade-up" data-aos-delay="50">
                                ...
                                <div class="feature-content">
                                    ...
                                    <p>“From Contacts To Customers Through Digital Conversions”
                                        With social media platforms as big as countries, it has pro
                                        vided a great medium to connect with people.</p>
                                    <p> Not only we
                                        help you to promote your products/services through unique
                                        & engaging ways on the digital platforms, but also assist in
                                        getting high-quality and volume based leads with a low CPC
                                        (cost per click). </p>
                                </div>
                            ...
                            <div class="feature-card  bg-white shadow-sm rounded-custom p-5" data-aos="fade-up" data-aos-delay="50">
                                ...
                                <div class="feature-content">
                                    <h3 class="h5">BRAND BUILDING</h3>
                                    <p>At Starlight we are passionately curious about human behavior. </p>
                                    <p> view the world through a cultural lens and identify the codes that drive people to be who they are and
                                        behave how they do. Which is why, we start every project with a deep immersion with consumers.</p>
                                    <p> Understanding their behavior, their mind space and the spaces where our brand can influence their life.</p>
                                </div>
                                <a href="service-single.html" class="link-with-icon text-decoration-none mt-3">View Details <i class="fas fa-arrow-right"></i></a>
                            </div>
                            <div class="feature-card bg-white shadow-sm rounded-custom p-5" data-aos="fade-up" data-aos-delay="50">
