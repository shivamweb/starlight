...
<body>
    ...
    <div class="main-wrapper">
                    ...
                    <div class="col-lg-5 col-md-6">
                        <div class="digi-hero-text mt-5 mt-lg-0">
                            ...
                            <div class="action-btns mt-4 align-items-center d-block d-sm-flex d-lg-flex d-md-flex">
                                <a href="contact-us.html" class="btn rounded-pill bg-orange me-3">Download Now</a>
                                <a href="http://www.youtube.com/watch?v=hAP2QF--2Dg" class="text-decoration-none popup-youtube d-inline-flex align-items-center watch-now-btn mt-3 mt-lg-0 mt-md-0">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 col-md-6 col-xl-3">
                        <div class="digi-service-single bg-white p-4 mb-4 mb-xl-0">
                            ...
                            <p>Proactively recaptiualize multidisciplinary manufactured products vis-a-vis go forward resource
                                maximizing internal.
                            </p>
                            <a href="services.html" class="read-more-link text-decoration-none">Explore More <i class="fas fa-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-xl-3">
                        <div class="digi-service-single bg-white p-4 mb-4 mb-xl-0">
                    ...
                    <div class="col-lg-6 col-md-6 col-xl-3">
                        <div class="digi-service-single bg-white p-4 mb-4 mb-xl-0">
                            ...
                            <p>
                                Globally utilize emerging networks through team driven models develop team driven systems through.
                            </p>
                            <a href="services.html" class="read-more-link text-decoration-none">Explore More <i class="fas fa-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-md-12">
                            <div class="digi-newsletter">
                                ...
                                <p>
                                    Intrinsicly cultivate user-centric collaboration and idea-sharing after value-added processes
        ...
        <section class="digi-how-works bg-white ptb-120">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="digi-how-works-right bg-light-subtle mt-5 mt-lg-0">
                            <div class="dig-how-steps">
                                <ul class="list-unstyled mb-0">
                                    <li class="d-md-flex justify-content-between align-items-center mb-3 bg-white">
                                        <div class="me-3">
                                            <img src="assets/img/icons/st-1.png" class="img-fluid mb-3 mb-md-0" alt="icons" />
                                        </div>
                                        <div>
                                    ...
                                    <li class="d-md-flex justify-content-between align-items-center mb-3 bg-white">
                                        <div class="me-3">
                                            <img src="assets/img/icons/st-2.png" class="img-fluid mb-3 mb-md-0" alt="icons" />
                                        </div>
                                        <div>
                                    ...
                                    <li class="d-md-flex justify-content-between align-items-center bg-white">
                                        <div class="me-3">
                                            <img src="assets/img/icons/st-3.png" class="img-fluid mb-3 mb-md-0" alt="icons" />
                                        </div>
                                        <div>
        ...
        <!-- Integration Start -->
        <section class="digi-integration bg-dark position-relative" style="background: url('assets/img/page-header-bg.svg')no-repeat center bottom">
                        ...
                        <div class="col-lg-7">
                            <div class="position-relative">
                                ...
                                <div class="digi-nav-control">
                                    <span class="swiper-button-prev shadow-sm"><i class="fas fa-arrow-left"></i></span>
                                    <span class="swiper-button-next shadow-sm"><i class="fas fa-arrow-right"></i></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="text-center">
                            ...
                            <div>
                                ...
                                <a href="integrations.html" class="btn rounded-pill btn-outline-light mb-3">Browse all integration</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        ...
                        <div class="digi-blog-single border p-3 rounded mb-4 mb-lg-4">
                            <div class="digi-blog-thumb">
                                <a href="blog-single.html">
                                    <img src="assets/img/blog/d-blog-1.jpg" class="img-fluid w-100 rounded-top" alt="Person" />
                                </a>
                                <span class="d-tag marketing">Marketing</span>
                            </div>
                            <div class="mt-4 digi-blog-info">
                                <span class="fs-sm text-muted fw-normal"><i class="far fa-calendar me-2"></i>22 Feb, 2022</span>
                                <h4>
                                ...
                                <a href="blog-single.html" class="read-more-link text-decoration-none">Explore More <i class="fas fa-arrow-right ms-2"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="digi-blog-single border p-3 rounded mb-4 mb-lg-0">
                            <div class="digi-blog-thumb">
                                <a href="blog-single.html">
                                    <img src="assets/img/blog/d-blog-2.jpg" class="img-fluid w-100 rounded-top" alt="Person" />
                                </a>
